                    ...
                    <div className="p-6 space-y-4 md:space-y-6 sm:p-8">
                        ...
                        <form className="space-y-4 md:space-y-6">
                            ...
                            <div className="flex items-center justify-between">
                                ...
                                <Link href="#" className="text-sm font-medium text-purple-600 hover:underline">Mot de passe oublié?</Link>
                            </div>
                            ...
                            <p className="text-sm font-light text-gray-500">Vous n&apos;avez pas encore de compte? <Link href="/signup" className="font-medium text-purple-600 hover:underline">S&apos;incrire</Link>
                            </p>
                        </form>
                    </div>
                </div>
